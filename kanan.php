...
elseif ($_GET['module']=='alumni'){
  ...
  echo "<table><form method=POST action='admin/modul/cek_alumni.php'>
	<tr><td class=isi width=50 >NIM </td><td width=35><input type=text name=username size=35></td></tr>
	<tr><td class=isi width=50>Password </td><td width=35><input type=password name=password size=35></td></tr>
	<tr><td colspan='2'><input type='submit' value='Login'></td></tr>
	</form></table>";

  echo "<table><tr><td class=isi>Tidak memiliki password ? Silahkan <a href=media.php?module=registrasi>registrasi </a></td></tr>";  
...
elseif ($_GET['module']=='registrasi'){
  ...
  //echo "<form method=POST action='admin/modul/cek_alumni.php'>
	...
	echo "<table><form method=POST action='admin/modul/cek_alumni.php'>
	<tr><td class=isi width=120>NIM</td><td><input type=text name=nim size=40></td></tr>
	<tr><td class=isi>Nama Lengkap </td><td><input type=text name=nama size=40></td></tr>
	<tr><td class=isi>Tahun Lulus </td><td><input type=text name=thnlulus size=40></td></tr>
	<tr><td class=isi>Telephone/Handphone </td><td><input type=text name=telephone size=40></td></tr>
	<tr><td class=isi>Email </td><td><input type=text name=email size=40></td></tr>
	<tr><td class=isi>Website/Blog </td><td><input type=text name=website size=60></td></tr>
	<tr><td class=isi>Alamat tinggal </td><td><input type=text name=alamat size=60></td></tr>

	<tr><td colspan='2'><input type='submit' value='Submit'></td></tr>
	
	</form></table>";

  echo "<table><tr><td class=isi>Terima kasih atas informasi yang diberikan. Kami akan mengirim password ke email Anda</td></tr>";  
